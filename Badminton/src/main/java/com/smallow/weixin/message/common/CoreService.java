...
import com.smallow.weixin.message.resp.TextMessage;
...
public class CoreService {
    ...
    public static String processRequest(HttpServletRequest request) {
        ...
        try {
            ...
            //System.out.println("respContent1:"+respContent);
           // System.out.println("requestMap:"+requestMap.size());
            // 发送方帐号
            ...
            // 链接消息
                ...
                System.out.println("收到事件信息:"+eventType);
                // 关注
